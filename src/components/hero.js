            ...
            <svg id="hero-earth" className="hero-earth" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800.96 800.96">
                ...
                <g id="Day_Shine" data-name="Day Shine">
                    ...
                    <g>
                        ...
                        <polygon className="cls-6 sparkling" style={{animationDelay: "0.7s"}} points="699.73 53.19 702.39 62.29 711.49 64.95 702.39 67.61 699.73 76.7 697.08 67.61 687.98 64.95 697.08 62.29 699.73 53.19"/>
                        <polygon className="cls-6 sparkling" style={{animationDelay: "0.6s"}} points="30.83 157.35 33.49 166.45 42.59 169.11 33.49 171.77 30.83 180.87 28.17 171.77 19.07 169.11 28.17 166.45 30.83 157.35"/>
                        <polygon className="cls-5 sparkling" style={{animationDelay: "0.1s"}} points="102.53 52.5 105.19 61.6 114.29 64.26 105.19 66.92 102.53 76.02 99.87 66.92 90.77 64.26 99.87 61.6 102.53 52.5"/>
                        <polygon className="cls-5 sparkling" style={{animationDelay: "1.0s"}} points="774.93 274.01 777.59 283.11 786.68 285.77 777.59 288.43 774.93 297.53 772.27 288.43 763.17 285.77 772.27 283.11 774.93 274.01"/>
                        <polygon className="cls-5 sparkling" style={{animationDelay: "0.5s"}} points="464.21 112.18 466.87 121.28 475.97 123.94 466.87 126.6 464.21 135.7 461.55 126.6 452.45 123.94 461.55 121.28 464.21 112.18"/>
                        <polygon className="cls-5 sparkling" style={{animationDelay: "0.2s"}}  points="89.21 672.38 91.87 681.48 100.97 684.14 91.87 686.8 89.21 695.9 86.56 686.8 77.45 684.14 86.56 681.48 89.21 672.38"/>
                        <polygon className="cls-5 sparkling" style={{animationDelay: "0.8s"}} points="672.59 695.15 675.25 704.25 684.35 706.91 675.25 709.57 672.59 718.67 669.93 709.57 660.84 706.91 669.93 704.25 672.59 695.15"/>
                        <polygon className="cls-6 sparkling" style={{animationDelay: "0.3s"}} points="771.16 576.54 773.82 585.64 782.92 588.3 773.82 590.95 771.16 600.05 768.5 590.95 759.4 588.3 768.5 585.64 771.16 576.54"/>
                    </g>
                </g>
