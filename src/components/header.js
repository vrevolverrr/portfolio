...
export default function Header() {
    return (
        <div className="header-container">
            ...
            <p onClick={() => showToast("I'm sorry but that's not implemented yet")} className="header-nav-item">BLOGS</p>
            <p onClick={() => showToast("I'm sorry but that's not implemented yet")} className="header-nav-item">PROJECTS</p>
