...
import { showErrorToast, showToast } from '../utils/toast-controller';
...
export default function Header() {
    return (
        <div className="header-container">
            ...
            <p onClick={() => document.querySelector(".contact-container").scrollIntoView({behavior: 'smooth', block: 'end'})} className="header-nav-item" style={{marginRight: "20px"}}>CONTACT</p>
        </div>
    )
}